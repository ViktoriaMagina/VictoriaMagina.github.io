...
const jsCopy = () => {
    return src(paths.jsCopy.src)
        .pipe(sourcemaps.init('.'))
        .pipe(newer(paths.jsCopy.src))
        .pipe(dest(paths.jsCopy.dest))
        .pipe(browserSync.stream())
}
...
exports.start = series(
    parallel(html, img, favicon, scss, jsCopy, js, font),
...
exports.build = series(
    clear,
    parallel(html, scss, jsCopy, js, img, favicon, font),
)
